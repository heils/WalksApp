...
options.UseSqlServer(builder.Configuration.GetConnectionString("WalkDBConnection")));
...
builder.Services.AddIdentityCore<IdentityUser>()
    ...
    .AddTokenProvider<DataProtectorTokenProvider<IdentityUser>>("DbAuth")
